...
def build_vocab(imgs, params):
  ...
  print('numbcoco_img_sger of words in vocab would be %d' % (len(vocab), ))
    ...
    for name in tqdm(files):
      ...
      for rela in prela:
        try:
          ...
          print ("prela exception:", e)

      for rela in wrela:
        print (rela, rela.shape)
        print(i2r[rela[2]-1])  #subtract 1 since the label in wrela in our case starts from 1
        exit()
        try:
...
if __name__ == "__main__":
  ...
  # input json
  parser.add_argument('--input_json', default='/home/monika/Documents/PhD-Project/WeakVRD-Captioning/data/dataset_coco.json', help='input json file to process into hdf5')
  parser.add_argument('--output_json', default='/home/monika/Documents/PhD-Project/WeakVRD-Captioning/data/cocotalk.json', help='output json file')
  parser.add_argument('--output_h5', default='/home/monika/Documents/PhD-Project/WeakVRD-Captioning/data/cocotalk', help='output h5 file')
  parser.add_argument('--images_root', default='', help='root location in which images are stored, to be prepended to file_path in input json')

  parser.add_argument('--ro_dict', default='/home/monika/Documents/PhD-Project/WeakVRD-Captioning/data/coco_dicts.json', help='coco_dicts for objs and predicates')
  parser.add_argument('--ori_rela_dict', default='/home/monika/Documents/PhD-Project/WeakVRD-Captioning/data/coco_pred_sg_rela.npy', help='original vrg dict for objs, predicates')
  parser.add_argument('--cmb_folder', default='/home/monika/Documents/PhD-Project/WeakVRD-Captioning/data/vrg_ilp_apriori', help='original combined vrgs folder')
  ...
  parser.add_argument('--num_of_relas', default=200, type=int, help='top n predicates chosen.')
